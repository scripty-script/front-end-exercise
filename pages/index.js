...
export default function Home({ overview, trending }) {
    ...
    return (
        <>
            ...
            <main>
                <div id='hero' className='text-white bg-cover relative object-center'
                    style={{ backgroundImage: `url("./1008472.png")` }}>
                    ...
                    <section className='h-screen'>
                        ...
                        <div className='container mx-auto mt-32'>
                            <div className='grid lg:grid-cols-2'>
                                <div className='z-10'>
                                    <header className='lg:text-[5rem] text-5xl font-bold'>{overview.title}</header>
